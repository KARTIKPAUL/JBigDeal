        ...
        <div className="w-full max-w-7xl">
          ...
          >
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto text-gray-300">
              Welcome to JbigDeaL Fitness Gym – The Premier Fitness Destination in Falakata! We offer a 
          ...
          >
            ...
            <div className="space-y-4 text-lg text-gray-300">
              <p><MapPin className="inline mr-2" /> Arabinda Para, Ward 13, Near Club, Falakata, 735211</p>
              <p><Phone className="inline mr-2" /> +91 96796 56747</p>
              <p><Mail className="inline mr-2" /> jay@jbigdeal.org</p>
            </div>
          </motion.div>

        ...
        <div className="w-full lg:w-1/3 flex flex-col lg:items-start my-5 space-y-6">
            ...
            <div className="mt-4 text-gray-100 space-y-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-[#5d0000] font-bold text-lg">
                    <a href="tel:+919679656747">+91 96796 56747</a>
                  </p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-lg font-bold text-[#5d0000]">JbigDeaL Fitness Gym</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-lg font-bold text-[#5d0000]">
                    <a href="mailto:jay@jbigdeal.org">jay@jbigdeal.org</a>
                  </p>
              ...
              {/* Social Icons */}
              <div className="flex space-x-4 mt-4 text-gray-100 text-2xl">
                <a href="https://www.instagram.com/vajjiramagro" className="hover:text-[#2f2484]"><FaInstagram /></a>
                <a href="https://www.facebook.com/profile.php?id=61573384433125" className="hover:text-[#2f2484]"><FaFacebook /></a>

      ...
      <div className="w-full bg-gray-100 flex flex-col items-center py-12 px-6">
        ...
        <div className="max-w-6xl w-full text-center text-gray-900">
          <p className="text-lg mb-8">
            At <span className="font-bold text-[#5d0000]">JbigDeaL Fitness Gym</span> in Arabinda Para, Falakata, our personal trainers are dedicated to guiding you toward fitness success. With a blend of expertise, experience, and passion, they help members achieve their goals—whether you’re a beginner or a seasoned athlete.
          </p>
          <p className="text-lg mb-12">
            Our trainers design personalized workout plans, provide detailed exercise guidance, and keep you motivated throughout your journey. At JbigDeaL Fitness Gym, our trainers are more than just instructors—they are your partners in achieving lasting wellness.
          </p>
        </div>
